          ...
          <div className="product-similar__slider-list">
            <div className="product-card is-active">
              ...
              <div className="product-card__buttons">
                ...
                <a className="btn btn--transparent" href="src/components/pages/product/components/product-similar/product-similar#">Подробнее
                </a>
              </div>
            </div>
            <div className="product-card is-active">
              ...
              <div className="product-card__buttons">
                ...
                <a className="btn btn--transparent" href="src/components/pages/product/components/product-similar/product-similar#">Подробнее</a>
              </div>
            </div>
            <div className="product-card is-active">
              <div className="product-card__img">
              ...
              <div className="product-card__buttons">
                <button className="btn btn--purple product-card__btn" type="button">Купить</button>
                <a className="btn btn--transparent" href="src/components/pages/product/components/product-similar/product-similar#">
                  Подробнее
                </a>
              </div>
            </div>
